...
class FormBuilderChipsInput<T> extends FormBuilderField<List<T>> {
  ...
  @override
  FormBuilderChipsInputState<T> createState() => FormBuilderChipsInputState<T>();
}

class FormBuilderChipsInputState<T> extends FormBuilderFieldState<FormBuilderChipsInput<T>, List<T>> {}
